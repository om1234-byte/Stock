...
function Hero() {
    return ( 
        <div className='container'>
         ...
         <div className='row p-5 mt-5 border-top  text-muted ' style={{lineHeight:"1.8",fontSize:"14px"}}>
          ...
          <div className='col-6 p-5'>
             <p>
                We kick-started operations on the 15th of August,
                 ...
                 We named the company Kyne, a combination of Zero and "Rodha", the Sanskrit word for barrier.
             </p>
             <p>
